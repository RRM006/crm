...
-- CreateEnum
CREATE TYPE "CustomerStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'PENDING', 'CHURNED');
...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CALL', 'EMAIL', 'MEETING', 'TASK_COMPLETED', 'NOTE_ADDED', 'LEAD_CREATED', 'LEAD_STATUS_CHANGED', 'CUSTOMER_CREATED', 'DEAL_WON', 'DEAL_LOST', 'OTHER');
